    ...
    <>
        <div className={`${font.className} md:p-20 p-8 text-white w-full flex justify-between items-center flex-col md:flex-row bg-zinc-950`}>
            <div className='flex flex-col md:flex-row space-y-8 md:space-y-0 justify-between w-full items-center'>
                ...
                <div className='flex flex-col'>
                    <h1 className='text-2xl text-red-600 text-center md:text-left font-bold'>Quick Links</h1>
                ...
                <div className='flex flex-col'>
                    <h1 className='text-2xl text-red-600 font-bold md:text-left text-center'>Services</h1>
                ...
                <div className='flex flex-col'>
                    <h1 className='text-2xl text-red-600 font-bold md:text-left text-center'>Address</h1>
                    <h1 className='text-lg text-red-600 font-bold md:text-left text-center'>US Office</h1>
                    ...
                    <h1 className='text-lg text-red-600 pt-2 font-bold md:text-left text-center'>Canada Office</h1>
