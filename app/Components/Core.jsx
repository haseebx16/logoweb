  ...
  return (
    <div className={`${font.className} p-12 flex flex-col space-x-0 space-y-8 md:space-y-0 md:space-x-12 md:flex-row bg-zinc-900 text-white justify-center items-center`}>
        <div className='flex flex-col md:w-[50%]'>
            <h1 className='text-xl text-cyan-300 max-w-2xl font-bold'>Core Descernments</h1>
            <div className='flex'>
                    <img src='/men-icon.webp' className='h-14 w-14 mt-4 border-2 border-gray-700 p-2 rounded-full'/>
                <div className='flex flex-col'>
                    <h2 className='text-2xl text-red-600 mt-2 ml-4 font-bold'>DISCOVER YOUR BUSINESS POTENTIAL</h2>
            ...
            <div className='flex'>
                    <img src='/men-icon.webp' className='h-14 w-14 mt-4 border-2 border-gray-700 p-2 rounded-full'/>
                <div className='flex flex-col'>
                    <h2 className='text-2xl text-red-600 mt-4 ml-4 font-bold'>ENVISION YOUR LONG-TERM SUCCESS</h2>
            ...
            <div className='flex'>
                    <img src='/men-icon.webp' className='h-14 w-14 mt-4 border-2 border-gray-700 p-2 rounded-full'/>
                <div className='flex flex-col'>
                    <h2 className='text-2xl text-red-600 mt-4 ml-4 font-bold'>STRONG DIGITAL FOUNDATIONS FOR YOU</h2>
