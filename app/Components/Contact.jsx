    ...
    <div className={`${font.className} flex p-20 text-white w-full flex-col justify-start items-start bg-zinc-900`}>
        ...
        <form action="submit" className='w-full'>
            <div className='grid md:grid-cols-2 grid-cols-1 mt-12 gap-8'>        
                    ...
                    <input type='text' placeholder='Your Business Name' className='w-full p-4 border border-gray-700 bg-zinc-800 text-white rounded-md'/>
                    <div className='col-span-2 w-full'>
                        <input type='text' placeholder='https://' className='w-full p-4 border border-gray-700 bg-zinc-800 text-white rounded-md'/>
                    </div>
                    <div className='col-span-2 w-full'>
                    ...
                    <div className='col-span-2 w-full'>
                        <button className='w-full text-2xl py-4 text-white rounded-md bg-cyan-500'>
                            Submit
                        </button>
                    </div>
            </div>
