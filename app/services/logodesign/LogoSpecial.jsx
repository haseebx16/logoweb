...
const EcomSpecial = () => {
  return (
    <div className={`${font.className} flex bg-background flex-col justify-center items-center p-12`}>
            <h1 className='md:text-5xl text-white text-2xl font-bold text-center'>Services</h1>
            <div className='grid md:grid-cols-3 grid-cols-1 mt-8 gap-8'>
                <div className='p-12 flex hover:bg-white text-white hover:text-black duration-300 flex-col justify-center items-center border-2 border-zinc-600 rounded-sm'>
                    <h1 className='text-cyan-300 text-center text-3xl'>Mobile Compatible</h1>
                ...
                <div className='p-12 flex hover:bg-white text-white hover:text-black duration-300 flex-col justify-center items-center border-2 border-zinc-600 rounded-sm'>
                    <h1 className='text-cyan-300 text-center text-3xl'>Logistics Integration</h1>
                ...
                <div className='p-12 flex hover:bg-white text-white hover:text-black duration-300 flex-col justify-center items-center border-2 border-zinc-600 rounded-sm'>
                    <h1 className='text-cyan-300 text-center text-3xl'>Check-Out Features</h1>
                ...
                <div className='p-12 flex hover:bg-white text-white hover:text-black duration-300 flex-col justify-center items-center border-2 border-zinc-600 rounded-sm'>
                    <h1 className='text-cyan-300 text-center text-3xl'>Payment Gateway</h1>
                ...
                <div className='p-12 flex hover:bg-white text-white hover:text-black duration-300 flex-col justify-center items-center border-2 border-zinc-600 rounded-sm'>
                    <h1 className='text-cyan-300 text-center text-3xl'>Robust Showcasing</h1>
                    <p className='text-center pt-2'>
                    Convertible and mobile-ready apps are beneficial for our customers to create.</p>
                </div>
                <div className='p-12 flex hover:bg-white text-white hover:text-black duration-300 flex-col justify-center items-center border-2 border-zinc-600 rounded-sm'>
                    <h1 className='text-cyan-300 text-center text-3xl'>Shopping Cart</h1>
