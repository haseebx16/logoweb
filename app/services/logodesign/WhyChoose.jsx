...
const WhyChoose = () => {
  return (
    <div className={`${font.className} bg-background text-white p-12 flex flex-col justify-center items-center`}>
        <h1 className='text-3xl font-extrabold text-red-600 md:text-5xl'>Why Choose Us</h1>
        ...
        <h1 className='text-3xl font-extrabold text-red-600 pt-8 md:text-5xl'>Are You Ready To Upgrade?</h1>
